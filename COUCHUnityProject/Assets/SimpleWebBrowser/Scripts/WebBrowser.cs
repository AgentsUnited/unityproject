...
namespace SimpleWebBrowser
{
    ...
    public class WebBrowser : MonoBehaviour, IMiddlewareListener
    {
...
#region JS Query events
        ...
        public GameObject web_browser_object;
		public string user;
		public string pass;
		protected static ITextMessage message = null;
		protected static AutoResetEvent semaphore = new AutoResetEvent (false);
		public URLMsg urlMsg = new URLMsg();   
        protected AMQMiddleware amqMiddleware;
        ...
        void Start()
        {
            ...
            web_browser_object = GameObject.FindGameObjectWithTag ("web_browser");

            amqMiddleware = web_browser_object.GetComponent<ASAPToolkit.Unity.Middleware.AMQMiddleware>();
            amqMiddleware.Register(this);
		...
		public void OnMessage(MSG msg) {
			if (msg.src.Equals("topic://COUCH/UI/URL"))
			{
				URL_Control(msg.data);
			}

		}

		void URL_Control(String msg)
		{
			Debug.Log("URL message received, trying to make it a json");        
			try
			{
				urlMsg = JsonUtility.FromJson<URLMsg>(msg);
				Debug.Log("Made it a json: " + JsonUtility.ToJson(urlMsg).ToString());
			}
			catch (Exception e)
			{
			...
			_mainEngine.SendNavigateEvent(urlMsg.url, false, false);
