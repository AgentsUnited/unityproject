...
public class CharacterAnimation_Single_Autodesk : MonoBehaviour
{
        ...
        if (animateAgent)
        {
            ...
            if (distantConnection)
            {
                ...
                if (!thriftConsumerOpened)
                {
                    ...
                    {
                        //if (SceneManagerGreta.gretaClock <= 0)
                        ...
                        SceneManagerGreta.gretaClock = (float)characterTimer.getTimeMillis();
    ...
    public void PlayAgentAnimation(string animationID, InterpersonalAttitude attitude)
    {
        animateAgent = true;
    ...
    public void PlayAgentAnimation(string animationID)
    {
        PlayAgentAnimation(animationID, null);
    }
