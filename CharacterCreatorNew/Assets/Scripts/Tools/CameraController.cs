...
public class CameraController : MonoBehaviour
{
    ...
    public float x = SceneManagerGreta.xCamera;
    public float y = SceneManagerGreta.yCamera;
    public static float z = SceneManagerGreta.zCamera;
    ...
    public void Awake()
    {
        ...
        // target for rotation
        target = SceneManagerGreta.iTarget;
